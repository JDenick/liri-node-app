...
// Created a variable to access the keys.js file (which is in the same root directory) to access the api keys that are
// Creating variables for the required packages (spotify-api, axios, fs for read/write, and moment to convert to)
...
// Variables for the arguments to be entered by the user Liri
var appCommand = process.argv[2];
//console.log("appCommand: " + appCommand)
// Use the slice method to account for user's search starting with index 3 positioon forth because search could have
var userSearch = process.argv.slice(3).join(" ");
// console.log("userSearch: " + userSearch);

//Using switch statements to execute teh code appropriate to the appCommand that is inputed form the user
